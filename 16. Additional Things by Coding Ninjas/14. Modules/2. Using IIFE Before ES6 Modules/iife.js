//IIFE solve the problem of polluting the globel scope but still there is ording issue of js file in index.html
...
console.log(total)// this is still getting error when we suffle order of js file in index.html after using IIFE.+ fxzghyjg
